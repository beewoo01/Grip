...
import '../../../../../common/widget/w_loading.dart';
import '../../../../../main.dart';
...
class WroteReview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: viewModel.selectWroteReview(Singleton().getAccountIdx()),
                ...
                return Column(
                  children: [
                    ...
                    GestureDetector(
                        ...
                        child:
                            buildContentBox(snapShot.data?[position], context)
                                .pSymmetric(h: 20)),
                    height20,
                    buildAccountInfoBox(snapShot.data?[position].account_name,
                            snapShot.data?[position].review_createtime)
                        .pSymmetric(h: 20),
                    height20,
                    GestureDetector(
                      onTap: () {
                        final WroteReviewVO vo = snapShot.data![position];
                        navigate(context, ReviewDetail.route,
                            isRootNavigator: false,
                            arguments: {'vo': vo, 'viewModel': viewModel});
                      },
                      child: Row(
                        children: [
                          Container(
                          ...
                          Expanded(
                            ...
                            child: snapShot
                                .data?[position].review_description.text
                                .size(10)
